  ...
  return (
    <div className="p-8 bg-gray-50 dark:bg-primary min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-1">Track your store performance</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div className="bg-white dark:bg-secondary rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Sales Overview</h2>
          <div className="space-y-4">
            {salesData.map((data) => (
              <div key={data.month}>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-gray-600 dark:text-gray-300">{data.month}</span>
                  <span className="font-medium text-gray-900 dark:text-white">${data.sales.toLocaleString()}</span>
                </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Footwear</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">145 sales</p>
                </div>
              </div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">$14,500</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Tops</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">132 sales</p>
                </div>
              </div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">$13,200</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Bottoms</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">98 sales</p>
                </div>
              </div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">$9,800</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Accessories</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">87 sales</p>
                </div>
              </div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">$8,700</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-secondary rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Top Locations</h2>
          <div className="space-y-3">
