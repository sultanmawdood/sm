    ...
    <div className="min-h-screen bg-white dark:bg-primary">
      <div className="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-12 py-8 sm:py-12">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
          <div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary dark:text-white mb-2">
              All Products
            </h1>
          ...
          <div className="w-full lg:w-auto">
            <select
              ...
              className="w-full lg:w-auto px-4 py-2 bg-light dark:bg-secondary text-primary dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-sm"
              disabled={isLoading}
            >
          ...
          <aside className="w-full lg:w-64 flex-shrink-0">
            <div className="bg-light dark:bg-secondary rounded-lg p-6 sticky top-24">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-bold text-primary dark:text-white">Filters</h3>
                <button
                  onClick={clearFilters}
                  className="text-sm text-secondary dark:text-gray-300 hover:text-primary dark:hover:text-white transition-colors"
                  disabled={isLoading}
                >
                  Clear All
                </button>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 bg-white dark:bg-primary text-primary dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary pl-10 text-sm"
                    disabled={isLoading}
                  />
                  <svg
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  <input
                    ...
                    disabled={isLoading}
                  />
                  <div className="flex justify-between text-sm text-secondary dark:text-gray-300">
